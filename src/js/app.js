...
const getCoords = (position) =>{
  ...
  var imgMap = "https://maps.googleapis.com/maps/api/staticmap?center="+lat+","+lng+"&size=600x300&markers=color:OLIVEDRAB%7C"+lat+","+lng+"&key=AIzaSyCt9yjfxwLkam9k--FRqUyqn-nw2pOgrdY";
